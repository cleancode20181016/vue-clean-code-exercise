...
export class BudgetPlan {
    ...
    _getOverlappingDayCount(period, another) {
        let endOverlapping = period.end.isBefore(another.end) ? period.end : another.end;
        let startOverlapping = period.start.isAfter(another.start) ? period.start : another.start;
